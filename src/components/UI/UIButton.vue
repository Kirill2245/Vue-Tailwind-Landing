...
<script lang="ts">
    ...
    type ButtonVariant = 'contact_btn' | 'primary' | 'nav_btn'
        ...
        props: {
            variant: {
                ...
                validator: (value: string): value is ButtonVariant => 
                    ['primary', 'contact_btn', 'nav_btn'].includes(value)
            },
            size: {
                type: String as PropType<ButtonSize>,
                default: 'md',
                validator: (value: string): value is ButtonSize => 
                    ['sm', 'md', 'lg', 'xl', 'custom'].includes(value)
            },
            disabled: {
                type: Boolean,
                default: false
        ...
        setup(props) {
            const buttonClasses = computed(() => {
                ...
                const sizeClasses: Record<ButtonSize, string> = {
                    ...
                    custom:'px-6 py-4.5 text-lg font-medium'
                }
